...
public class SimpleDataType<T> implements DataType<T>
{
    ...
    public boolean isCompatibleWith(DataType dataType)
    {
        ...
        if ((this.getMimeType() == null && that.getMimeType() != null || that.getMimeType() == null && this.getMimeType() != null) && !MimeTypes.ANY.equals(this.mimeType) && !MimeTypes.ANY.equals(that.mimeType))
        {
            return false;
        }

        if (this.getMimeType() != null && !this.getMimeType().equals(that.getMimeType()) && !MimeTypes.ANY.equals(that.getMimeType()) && !MimeTypes.ANY.equals(this.getMimeType()))
        {
            return false;
        }
    ...
    public boolean equals(Object o)
    {
        ...
        //ANY_MIME_TYPE will match to a null or non-null value for MimeType
        if ((this.mimeType == null && that.mimeType != null || that.mimeType == null && this.mimeType != null) && !MimeTypes.ANY.equals(that.mimeType))
        {
            return false;
        }

        if (this.mimeType != null && !mimeType.equals(that.mimeType) && !MimeTypes.ANY.equals(that.mimeType))
        {
            return false;
        }
