...
public class TypeSafeExpressionValueResolver<T> implements ValueResolver<T>
{
    ...
    private T transform(T object, MuleEvent event) throws MuleException
    {
        ...
        org.mule.runtime.api.metadata.DataType sourceDataType = dataTypeBuilder(object.getClass()).build();
        org.mule.runtime.api.metadata.DataType targetDataType = dataTypeBuilder((Class<T>) expectedClass).build();
