...
public class XQueryTransformer extends AbstractXmlTransformer implements Disposable
{
    ...
    public XQueryTransformer()
    {
        ...
        registerSourceType(dataTypeBuilder(DocumentSource.class).build());
        registerSourceType(dataTypeBuilder(org.dom4j.Document.class).build());
        registerSourceType(dataTypeBuilder(Document.class).build());
        registerSourceType(dataTypeBuilder(Element.class).build());
        registerSourceType(INPUT_STREAM_DATA_TYPE);
        setReturnDataType(dataTypeBuilder(List.class).build());
    }
