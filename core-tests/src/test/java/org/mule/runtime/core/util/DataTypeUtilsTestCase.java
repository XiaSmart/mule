...
import static org.mule.runtime.api.metadata.MimeTypes.APPLICATION_JSON;
...
public class DataTypeUtilsTestCase extends AbstractMuleTestCase
{
    ...
    {
        final DataType dataType = dataTypeBuilder(Object.class).forMimeType(APPLICATION_JSON).withEncoding(UTF_8.name()).build();
    ...
    {
        DataType<Object> dataType = dataTypeBuilder(Object.class).forMimeType(MimeTypes.APPLICATION_JSON).build();
